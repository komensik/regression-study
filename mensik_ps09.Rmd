...
-   *interpretation*:
    ...
    -   an additional access point per mile is associated with a 0.09 increase in accidents/million miles, and this effect is statistically significant at the 1% level (because the p value is less than 0.01), where the confidence interval is [0.028, 0.154].
...
table1_table <- knitr::kable(table1,
                             format = "html",
                             longtable=FALSE,
                             caption = "Het-Robust SEs Table")

styled_table1_table <- kable_styling(
  table1_table,
  full_width = FALSE,
